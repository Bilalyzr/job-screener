...
:root{
  ...
  --line:#dde3f0; --line-hi:#b9c4dc;
  --text:#1a2333; --muted:#5b6780;
  --primary:#2563eb; --accent:#b45309; --ok:#047857; --warn:#b45309;
...
.job:hover{border-color:var(--line-hi);box-shadow:0 4px 16px rgba(15,23,42,.10)}
...
.badge.pri{background:#fef3c7;color:#92400e}
.badge.watch{background:#ffedd5;color:#b45309}
.chip{font-size:var(--fs-12);padding:2px var(--sp-2);border-radius:999px;border:1px solid}
.chip.swe{color:#1d4ed8;border-color:#bfdbfe}
.chip.cyber{color:#047857;border-color:#a7f3d0}
.chip.other{color:#6d28d9;border-color:#ddd6fe}
...
.btn{display:inline-flex;align-items:center;min-height:44px;padding:0 var(--sp-4);background:var(--primary);color:#ffffff;font-weight:600;font-size:var(--fs-14);border-radius:var(--rad-s);text-decoration:none;border:0;cursor:pointer}
...
pre{white-space:pre-wrap;max-width:75ch;font-family:inherit;font-size:var(--fs-14);color:#334155;background:var(--surface2);border:1px solid var(--line);border-radius:var(--rad-s);padding:var(--sp-3);margin-top:var(--sp-2)}
